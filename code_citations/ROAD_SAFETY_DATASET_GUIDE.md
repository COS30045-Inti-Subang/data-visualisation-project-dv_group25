...
### **Option 3: Australian Road Deaths(1990-2025)** ⭐ BEST FOR LONG-TERM TRENDS

**File:** `Australian Road Deaths Database September 2025 (2).csv`

**Why this adds context:**

- ✅ 20+ **years** of historical data (1990s-2020s)
...
- 📈 **Line chart:** Long-term death rate trends (shows improvement over time)
